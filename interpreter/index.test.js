const { Interpreter, EXECUTION_LIMIT } = require('./index');
const {
    STOP,
    ADD,
    SUB,
...
describe('Interpreter', () => {
    describe('runCode()', () => {
        ...
        describe('and the code includes JUMPI', () => {
            it('conditionally jumps to a destination', () => {
                expect(
        ...
        describe('and the code includes an infinite loop', () => {
            it('throws an error', () => {
                ...
                ).toThrow(`Check for an infinite loop. Execution limit of ${EXECUTION_LIMIT} was exceeded`);
            });
        });
